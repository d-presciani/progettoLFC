...
Vista la struttura del programma si ritiene che la struttura ideale sia di tipo pipe and filter, dove si possono identificare specifici moduli e ogni modulo genera dei risultati intermedi che verranno poi utilizzati dai moduli successivi.\par
