...
\item\underline{aggiungiCompletamento}(\textit{nuovaRdp}, \textit{regolaPadre}): funzione ausiliaria chiamata in \underline{aggiungiCore}, si occupa di aggiungere \textit{nuovaRdp} alle regole di completamento e aggiunge i seguiti di \textit{regolaPadre} in caso questa sia annullabile;
...
\EndFor
\EndIf
\State TODO: Continuare da riga 26 del TXT
\EndIf
\EndFor
\end{algorithmic}
\end{algorithm}
