...
\item Versione 2.0 - 02/10/2019 : Esiti dei test della versione 2
\end{itemize}
...
\end{itemize}
La versione oggetto di test è la 2.0, pubblicata sul branch \textit{master} della repository di Github del progetto (\url{https://github.com/d-presciani/progettoLFC}) in data 02/10/2019.
\pagebreak
