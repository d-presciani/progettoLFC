...
public class PrototipoLR1Lexer extends Lexer {
	...
	public final void mSZ() throws RecognitionException {
		try {
			...
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:197:5: ( 'S0' )
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:197:7: 'S0'
			{
			match("S0"); 
	...
	public final void mEQ() throws RecognitionException {
		try {
			int _type = EQ;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:198:4: ( '->' | ':=' )
			int alt1=2;
			...
			switch (alt1) {
				case 1 :
					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:198:6: '->'
					{
					match("->"); 
					...
					break;
				case 2 :
					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:198:13: ':='
					{
					match(":="); 
	...
	public final void mNT() throws RecognitionException {
		try {
			int _type = NT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:199:5: ( ( 'A' .. 'Z' ) )
	...
	public final void mCT() throws RecognitionException {
		try {
			int _type = CT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:200:4: ( ( 'a' .. 'z' ) | ( '0' .. '9' ) | '+' | '-' | '*' | '/' )
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:
			{
	...
	public final void mTER() throws RecognitionException {
		try {
			int _type = TER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:201:5: ( '/swa' | '/cjswa' )
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:201:7: '/swa'
					{
					match("/swa"); 
					...
					break;
				case 2 :
					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:201:16: '/cjswa'
					{
					match("/cjswa"); 
	...
	public final void mSC() throws RecognitionException {
		try {
			int _type = SC;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:202:5: ( ';' )
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:202:7: ';'
			{
			match(';'); 
			}
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:205:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' | '/*' ( options {greedy=false; } : . )* '*/' )
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:205:9: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
					{
					match("//"); 

					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:205:14: (~ ( '\\n' | '\\r' ) )*
					loop3:
					while (true) {
						int alt3=2;
					...
					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:205:28: ( '\\r' )?
					int alt4=2;
					...
					break;
				case 2 :
					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:206:9: '/*' ( options {greedy=false; } : . )* '*/'
					{
					match("/*"); 

					// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:206:14: ( options {greedy=false; } : . )*
					loop5:
					while (true) {
						int alt5=2;
						...
						switch (alt5) {
						case 1 :
							// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:206:42: .
							{
							matchAny(); 
							}
							break;
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:209:5: ( ( ' ' | '\\t' | '\\r' | '\\n' ) )
			// C:\\Users\\Luka8\\Desktop\\progettoLFC\\PrototipoLR1.g:209:9: ( ' ' | '\\t' | '\\r' | '\\n' )
			{
